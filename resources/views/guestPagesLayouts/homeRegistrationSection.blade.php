        ...
        <div class="col-sm-6 col-xs-12">
            <div class="panel panel-default text-center">
                ...
                <div class="panel-body">
                    <div class="row">
                        <form class="form-horizontal" id="reg_form" action="{{route('mentors.store')}}" method="post">
                            {{ csrf_field() }}
                            <div class="form-group">
                                ...
                                <div class="col-md-12  inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i
                                        ...
                                        <input name="first_name" placeholder="Vardaitis" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12 inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i
                                                    class="glyphicon glyphicon-user"></i></span>
                                        <input name="last_name" placeholder="Pavardaitis" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12  inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i
                                        ...
                                        <input name="email" placeholder="vardaitis.pavardaitis@pastas.lt"
                                ...
                                <div class="col-md-12  inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i
                                        ...
                                        <input class="form-control {$borderColor}" id="userPw2" type="password"
                                               placeholder="Pakartokite spaltažodį"
                                               name="password_confirmation" data-match="#password_confirmation"
                                               data-minLength="6"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12  inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i
                                        ...
                                        <input name="age" placeholder="20" class="form-control" type="number" id="age"
                                               min="6" data-bind="value:replyNumber" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12  inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i
                                        ...
                                        <input name="city" placeholder="Vilnius" class="form-control" type="text"
                                               id="city" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="control-label" for="topic">Mokomas dalykas:</label>
                                <div class="col-md-12  inputGroupContainer">
                            ...
                            <div class="form-group">
                                <label for="fixed_hour_price">Pamokos kaina:</label>
                                <div class="col-md-12  inputGroupContainer">
                                    <div class="input-group"><span class="input-group-addon"><i
                                                    class="glyphicon glyphicon-euro"></i></span>
                                        <input type="number" class="form-control" id="fixed_hour_price"  placeholder="10" min="0" name="fixed_hour_price" required>
                                    </div>
                                </div>
                            </div>
