...
@endsection
@section('content')
    <form id="form-change-password" role="form" method="POST" action="{{ url('/users/dashboard/change') }}" novalidate class="form-horizontal">
        <div class="col-md-9">
            ...
            <label for="password_confirmation" class="col-sm-4 control-label">Naujo Slaptažodžio Patvirtinimas</label>
            <div class="col-sm-8">
                <div class="form-group">
